...
.pull-left[
- split and resampling : [`rsample`](https://rsample.tidymodels.org/)

- preprocess : [`recipes`](https://recipes.tidymodels.org/)

- modeling : [`parsnip`](https://parsnip.tidymodels.org/)

- tune models: [`tune`](https://tune.tidymodels.org/)
...
---
## Feuture engineering with <span style="color:red">**recipes**</span>
...
---
## Tune hyperparameters in <span style="color:red">workflow</span>

`workflow` stitch all elements together
...
---
## finalize workflow and evalute model with <span style="color:red">yardstick</span>
